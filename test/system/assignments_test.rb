...
class AssignmentsTest < ApplicationSystemTestCase
  ...
  test "creating a Assignment" do
    ...
    fill_in "Categories", with: @assignment.categories_id
    fill_in "End", with: @assignment.end
    fill_in "Statuses", with: @assignment.statuses_id
    fill_in "Title", with: @assignment.title
    fill_in "Users", with: @assignment.users_id
